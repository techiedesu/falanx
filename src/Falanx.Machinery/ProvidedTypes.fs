    ...
    and TypeSymbol(kind: TypeSymbolKind, typeArgs: Type[]) as this =
        ...
        override this.GetEvent(name, bindingFlags) = 
            ...
            | TypeSymbolKind.OtherGeneric gtd ->
                ...
                |> Option.toObj
            | _ ->
                notRequired this "GetEvent" this.Name

        override this.GetNestedType(_name, _bindingFlags) = null // notRequired this "GetNestedType" this.Name
